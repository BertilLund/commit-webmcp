...
- Submission candidate commit: `8875f1f` (navigation-free, one-decision-at-a-time review flow; to be tagged immediately before Devpost submission).
- Cloudflare Pages project: `commit-webmcp`
- Current production deployment: https://93ec771d.commit-webmcp.pages.dev
- License: MIT
