...
Verified 2026-08-26 from the [OpenAI challenge page](https://openai.com/webmcp-challenge/) and [Devpost official rules](https://webmcp.devpost.com/rules).

## Deadline

- Submission deadline: **September 3, 2026, 1:00 PM Pacific Time** (22:00 CEST / Copenhagen).
...
- A working live URL accessible in ChatGPT's in-app browser or Chrome 149+ with `chrome://flags/#enable-webmcp-testing` enabled.
...
Entrants must be the age of majority locally and resident/organized in an OpenAI API-supported country or territory. The official rules include exclusions and restrictions; the entrant must confirm their own eligibility. One entrant may submit only one submission.
...
Ties are broken first by WebMCP Leverage. After the deadline, Devpost submissions cannot be edited except when Devpost/Sponsor permits a limited corrective change.
